<?php
$catid = cs_get_option('catid');
$catslug = cs_get_option('catslug');
?>
<section class="cat-single-one">
    <div class="container">
        <div class="row">  
            <div class="col-lg-6 col-md-12 pl-lg-0"> <h2 class="cat-title"><?php echo cs_get_option('cattitle'); ?></h2></div>
