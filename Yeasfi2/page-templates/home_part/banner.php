...
<?php if (cs_get_option('slider_switcher') == 0) { ?>    
    <section id="banner" class="">
        <div class="container">
            <div class="row">
                <div class="col-1"></div>
                <div class="bannerelement col-md-12 col-lg-12 animatedParent text-center">
                    <div class="bannert1"><h1 class="wow fadeInLeft animated"><?php echo $bannert1 = cs_get_option('bannert1'); ?></h1></div>
                    <div class="bannert2 "><h2 class="wow fadeInLeft animated"><?php echo $bannert2 = cs_get_option('bannert2'); ?></h2></div>
                    <?php if (cs_get_option('actionbtn') == 1) { ?>  
                        <a  class="applybtn wow fadeInLeft animated" data-wow-duration="1s" style="visibility: visible;-webkit-animation-duration:1s; -moz-animation-duration:1s; animation-duration:1s;" href="<?php echo cs_get_option('actionbtnurl'); ?>"><?php echo cs_get_option('actionbtntxt'); ?></a>
                    <?php }; ?>
                   
                </div>
                <div class="bannerelement col-md-12 col-lg-3">
