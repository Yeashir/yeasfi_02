...
<div class="tetel-inner-page">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2 id="page-<?php the_ID(); ?>" class="innerpage-titel"> <?php echo cs_get_option('blogtitle') ?> </h2>
            </div>
        </div>
    </div>
</div>
                            ...
                            <div class="row">
                                ...
                                <div class="titel-blog col-lg-12 col-md-12">
                                    <a href="<?php the_permalink(); ?>"><?php the_title(); ?></a>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-lg-6 aurthor"><i class="fa fa-user-o" aria-hidden="true"></i> <?php echo get_the_author(); ?> </div>
                                            <div class="col-md-12 col-lg-6  date"><i class="fa fa-clock-o" aria-hidden="true"></i> <?php the_time('d - m - Y'); ?></div>
                                        </div>
